...
use App\Filament\Resources\SalesSendDocumentsResource\Pages;
use App\Filament\Resources\SalesSendDocumentsResource\RelationManagers;
...
class SalesSendDocumentsResource extends Resource
{
    ...
    {
        return [
            'index' => Pages\ListSalesSendDocuments::route('/'),
            'create' => Pages\CreateSalesSendDocuments::route('/create'),
            'edit' => Pages\EditSalesSendDocuments::route('/{record}/edit'),
        ];
    }
}
