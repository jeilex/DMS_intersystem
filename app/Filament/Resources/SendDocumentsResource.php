...
use App\Filament\Resources\SendDocumentsResource\Pages;
use App\Filament\Resources\SendDocumentsResource\RelationManagers;
...
class SendDocumentsResource extends Resource
{
    ...
    {
        return [
            'index' => Pages\ManageSendDocuments::route('/'),
        ];
    }
}
