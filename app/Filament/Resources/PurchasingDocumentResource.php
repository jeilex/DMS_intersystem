...
use App\Filament\Resources\PurchasingDocumentResource\Pages;
use App\Filament\Resources\PurchasingDocumentResource\RelationManagers;

class PurchasingDocumentResource extends Resource
{
    protected static ?string $model = PurchasingDocument::class;
    ...
    {
        return [
            'index' => Pages\ListPurchasingDocuments::route('/'),
            'create' => Pages\CreatePurchasingDocument::route('/create'),
            'edit' => Pages\EditPurchasingDocument::route('/{record}/edit'),
        ];
    }
}
