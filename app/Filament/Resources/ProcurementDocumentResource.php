...
use App\Filament\Resources\ProcurementDocumentResource\Pages;
use App\Filament\Resources\ProcurementDocumentResource\RelationManagers;
...
class ProcurementDocumentResource extends Resource
{
    ...
    {
        return [
            'index' => Pages\ListProcurementDocuments::route('/'),
            'create' => Pages\CreateProcurementDocument::route('/create'),
            'edit' => Pages\EditProcurementDocument::route('/{record}/edit'),
        ];
    }
}
