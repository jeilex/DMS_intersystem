...
use App\Filament\Resources\AllDocumentsResource\Pages;
use App\Filament\Resources\AllDocumentsResource\RelationManagers;
...
class AllDocumentsResource extends Resource
{
    protected static ?string $model = AllDocuments::class;
    ...
    {
        return [
            'index' => Pages\ListAllDocuments::route('/'),
            'create' => Pages\CreateAllDocuments::route('/create'),
            'edit' => Pages\EditAllDocuments::route('/{record}/edit'),
        ];
    }
}
